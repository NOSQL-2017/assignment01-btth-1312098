...
router.post('/', function(req, res) {
      ...
      db.any('INSERT INTO sach(url, tensach, giatien, gioithieu, danhmuc , sohuu ) values($1, $2, $3, $4, $5, $6)',[req.body.url, req.body.tensach,req.body.giatien,req.body.gioithieu, req.body.danhmuc,req.body.sohuu])
        .then(function(data) {
